...
def gaganjitPageView(request):
    # return request object and specify page.
    return render(request, 'gaganjit.html')
...
def results(request, choice, gmat):
    ...
    # load saved model
    with open('C:\\Users\heerg\Documents\COMP4948-Predictive_Machine_Learning\COMP4948\helloworld\model_pkl', 'rb') as f:
